import { Form, Row, Col, Alert, FormLabel } from "react-bootstrap";
                        ...
                        <Row>
                            <Col md={6}>
                                <Form.Group className="mb-3">
                                    <FormLabel htmlFor="name">Nombre Bebida</FormLabel>
                                    <Field
                                        id="name"
                                        type="text"
                            ...
                            <Col md={6}>
                                <Form.Group className="mb-3">
                                    <FormLabel htmlFor="category">Categoria Bebida</FormLabel>
                                    <Field
                                        id="category"
                                        name="category"
                                        as={Form.Select}
